...
<html>
	<head>
		...
		<title>Cincinnati Dental Society</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://cincinnatidental.org" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-b" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b"><a class="ui-btn velikodugme buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>"><img src='img/mail.png' style='width: 46px; padding-top: 9px;'><br>Contact</a></div>
					<div class="ui-block-c" id="findUS">
						<script>
							...
							if(/Android|webOS|Opera Mini/i.test(navigator.userAgent) ) {
								...
								dugme.innerHTML="<img src='img/location.png' style='width: 37px; padding-top: 5px;'><br>Find Us<br>Find Us";
								...
								dugme.innerHTML="<img src='img/location.png' style='width: 37px; padding-top: 5px;'><br>Find Us";
								prostordugme.appendChild(dugme);
							}
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">About Us</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Join</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Member Login</a></div>
              </div>              	
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Join</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Member Login</a></li>							
